...
`C:\HPBSM\opr\bin>opr-node.bat -ln -username admin -password Admin_123 >> c:\opr_node.txt`
...
`C:\HPBSM\opr\bin>opr-node-hc-config.bat -user admin -password Admin_123 -list_nodes -all -det >> c:\hc_config.txt`
